...
export const AUTH_API_BASE = import.meta.env.VITE_AUTH_API_BASE ?? 'https://vocicebank.joshsoftware.com'
...
export const VOICEPRINT_API_BASE =
  import.meta.env.VITE_VOICEPRINT_API_BASE ?? 'https://vocicebank.joshsoftware.com'
